...
The subject contains two artifacts concatenated: a specification with Req-IDs, then a diff. For EACH Req-ID in the spec: confirm the diff implements it, identify unverified claims, and flag requirement drift. Report missing coverage and scope leakage.
