...
The subject is a specification (requirements, acceptance criteria, interface contract). Review for clarity, testability, completeness, and internal consistency. Code-quality criteria (5, 7, 8, 9) apply only to code snippets embedded in the spec.
