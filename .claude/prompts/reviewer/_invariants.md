# Reviewer invariants (canonical source)

Lint-enforced single source of truth for preamble/criteria/adversarial-rigor blocks across all reviewer templates.
Do not edit templates directly — edit here and regenerate.
