---
name: planner-xhigh
description: Very-high-effort variant of planner for very deep multi-domain architecture design and frontier-grade epic planning — see docs/effort_tiers.md
