---
name: explore-high
description: High-effort variant of explore for deep research synthesis and multi-file service tracing.
model_tier: fast-search
effort: high
tools: [Read, Search]
---
<!-- Body must stay in sync with explore.md. Frontmatter diverges intentionally. -->
