---
name: general-purpose-xhigh
description: Very-high-effort variant of general-purpose for very deep architectural restructuring and complex multi-service implementation — see docs/effort_tiers.md
