---
name: qa-standards-xhigh
description: Very-high-effort variant of qa-standards for very deep multi-service refactor audits and cross-domain standards checks — see docs/effort_tiers.md
