---
name: deep-researcher-xhigh
description: Very-high-effort variant of deep-researcher for very deep cross-repo lineage tracing and 300+ file context analysis — see docs/effort_tiers.md
