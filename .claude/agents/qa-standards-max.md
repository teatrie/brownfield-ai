---
name: qa-standards-max
description: Max-effort variant of qa-standards for frontier multi-service refactor audits and cross-domain standards checks — see docs/effort_tiers.md
